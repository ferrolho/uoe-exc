...
hadoop jar /opt/hadoop/hadoop-2.7.3/share/hadoop/tools/lib/hadoop-streaming-2.7.3.jar \
 ...
 -output /user/$USER/assignment1/task3-temp \ # store 1st job output on temp folder
 -mapper mapper.py \
 -combiner reducer.py \ # reducer code can be used as combiner
 -reducer reducer.py
...
hadoop jar /opt/hadoop/hadoop-2.7.3/share/hadoop/tools/lib/hadoop-streaming-2.7.3.jar \
 ...
 -D mapreduce.job.reduces=1 \ # run 1 reducer only
 -files reducer.py \
